...
contract("CW20Handler - [Deposit ERC20]", async (accounts) => {
  ...
  it("Varied recipient address with length 40", async () => {
    ...
    const depositTx = await BridgeInstance.deposit(
      domainID,
      resourceID,
      Helpers.createERCDepositData(tokenAmount, lenRecipientAddress, recipientAddress),
      feeData,
    ...
    TruffleAssert.eventEmitted(depositTx, "Deposit", (event) => {
      return (
        ...
        event.data === Helpers.createERCDepositData(tokenAmount, lenRecipientAddress, recipientAddress).toLowerCase() &&
